    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-3xl mx-auto px-6 h-14 flex items-center gap-4">
          <Link href="/admin/dashboard" className="text-sm text-gray-400 hover:text-slate-600 transition duration-200">
            ← 목록으로
          </Link>
          <h1 className="text-base font-semibold text-slate-900">새 글 작성</h1>
        </div>
      </header>
